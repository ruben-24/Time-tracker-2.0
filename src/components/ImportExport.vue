...
<template>
  <div class="space-y-4">
    ...
    <div>
      ...
      <input
        type="file"
        accept=".json,application/json,.xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,.xls,application/vnd.ms-excel,.csv,text/csv,application/csv"
        @change="doImport"
      />
